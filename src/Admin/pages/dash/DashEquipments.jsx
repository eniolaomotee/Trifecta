        ...
        <div className='main-body bg-colr'>
          ...
          <div className="contenty px-2 pr-5" onClick={closeNav}>
            ...
            <div className='search-buttonx xpx-2 my-6 relative grid grid-cols-12 gap-2'>
              ...
              <input type="text" className="md:col-span-10 col-span-8 shadow appearance-none border rounded xw-9/12 py-2 pl-10 text-blue-700 bg-gray-100 focus:outline-none focus:shadow-outline " placeholder="Enter Comapny Name" id='title-search' name='title-search' onChange={SearchFilter}/>
