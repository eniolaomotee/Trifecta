      ...
      <div className='main-body bg-colr'>
        ...
        <div className="contenty px-2 pr-5">
          <div className='search-buttonx xpx-2 my-2 relative grid grid-cols-12 gap-2'>
            ...
            <button onClick={handleShow} className='col-span-2 button-solidx py-2 text-sm'><FontAwesomeIcon icon={['fas', 'plus']}/><span className='ml-2'>New Equipment</span></button>
            {/* <button className='col-span-2 button-inversex py-2 text-sm'>Request Equipment</button> */}
          </div>
          
          <EquipmentsTable data={equipments} rowsPerPage={10} handleShow={handleShowEdit}/>
