          ...
          <div className={`main-body col-span-7 row-span-5 bg-colr || xgrid xgrid-rows-10 xgap-2`}>
            ...
            <div className="contentx" onClick={closeNav}>
              ...
              <div className='search-buttonx my-6 relative grid grid-cols-12 gap-2'>
                ...
                <input type="text" className="md:col-span-10 col-span-7 shadow appearance-none border rounded xw-9/12 py-2 pl-10 text-blue-700 bg-gray-100 focus:outline-none focus:shadow-outline " placeholder="Enter Meeting Title" id='title-search' name='title-search' onChange={SearchFilter}/>
