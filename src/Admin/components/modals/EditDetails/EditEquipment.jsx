            ...
            <div className="modal-inner-edit">
                ...
                <form className="grid grid-cols-7 gap-5 px-10 py-6">
                    <div className="col-span-7 text-left">
                        ...
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="item-number" placeholder="Grinding Tool Dynamometer" name='item-number'/>
                    </div>
                    <div className="col-span-1 text-left">
                        <label className='xtext-blue-900' htmlFor="item-number">Item Number</label>
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="item-number" placeholder="25737" name='item-number'/>
                    </div>
