            ...
            <div className="modal-inner-edit-x">
                ...
                <form className="grid grid-cols-6 gap-4 px-10 py-6">
                    <div className="col-span-6 text-left">
                        ...
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 bg-white mt-2 focus:outline-none focus:shadow-outline " placeholder="Enter Task name" id='task-name' name='task-name'/>
                    </div>
                    <div className="col-span-6 text-left">
                        <label className='text-blue-900' htmlFor="scope">Task Scope</label><br></br>
                        <textarea type="text" className="shadow appearance-none border rounded w-full py-2 px-3 bg-white mt-2 focus:outline-none focus:shadow-outline bg-gray-200" placeholder="Enter Task Scope" id='scope' name='scope'></textarea>
                    </div>
                    <div className="md:col-span-3 col-span-6 text-left">
                        ...
                        <select type="text" className="shadow border txt-dark-bluex rounded w-full py-2 px-3 txt- bg-gray-200 mt-2 focus:outline-none focus:shadow-outline" id="initiated-by" name='initiated-by'>
                            {people.map(e=>{return <option value={e.name}>{e.name}</option>})} 
                        </select>
                    </div>
                    <div className="md:col-span-3 col-span-6 text-left">
                    ...
                    <div className="col-span-6 grid grid-cols-8 gap-4">
                        <div className="col-span-2 text-left">
                            ...
                            <select type="text" className="shadow xappearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-200 mt-2 focus:outline-none focus:shadow-outline" id="username" name="username">
                     ...
                     <div className="col-span-6 text-left">
                        ...
                        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-200 mt-2 focus:outline-none focus:shadow-outline" id="remarks" name='remarks' placeholder='Enter Task Remarks'></textarea>
                    </div>

                    <input type="submit" className="md:col-start-5 col-start-3 md:col-span-2 col-span-3 shadow appearance-none border rounded w-full py-2 px-3 text-white bg-blue-800 mt-2 focus:outline-none focus:shadow-outline" id='submit-button' value='Save Changes'/>
                </form>
            </div>
        </div>
    </div>
