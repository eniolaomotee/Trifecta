            ...
            <div className="modal-inner-edit-x2">
                ...
                <form className="grid grid-cols-4 grid-row-7 gap-4 px-10 py-6">
                    <div className="col-span-2 text-left">
                        ...
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline " placeholder="Enter Project Title" id='project-title' name='project-title'/>
                    </div>
                    <div className="col-span-2 text-left">
