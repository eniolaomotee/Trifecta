...
export default function EditExpense(props) {
    ...
    const handleCategoryChange = () => {
        if(document.getElementById('category_edit').value === "project"){setIsProject(true);}
        ...
        <div className="xback-board txt-dark-bluex relative">
            ...
            <div className='modal-edit-head-v2 relative'>
                ...
                <form className="grid grid-cols-3 gap-4 px-6 py-6">
                    ...
                    <div className="col-span-1 text-left"> 
                        <label className='' htmlFor="category_edit">Category</label>
                        <select className="shadow border rounded w-full py-2 px-3 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="category_edit" placeholder="Select Category" name='category_edit' onChange={handleCategoryChange}>
