        ...
        <div className="xback-board txt-dark-bluex">
            <div className="modal-inner">
                <div className='modal-edit-head-v2 relative'>
                    ...
                    <h1 className=' p-2 pl-5 edit-modal-headr-x'>Add New Project</h1>
                </div>
                <form className="grid grid-cols-4 grid-row-7 gap-4 px-10 py-6">
                    ...
                    <div className="md:col-span-1 col-span-4 text-left">
                        ...
                        <select type="text" className="shadow xappearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="username" name="username">
                    ...
                    <div className="md:col-span-1 col-span-4 text-left">
                        ...
                        <input type="date" className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id='take-off-dater' name='take-off-dater'/>
                    </div>
                    <div className="md:col-span-1 col-span-4 text-left">
                    ...
                    <div className='col-span-4'>
                        <label>Remarks</label>
                        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" placeholder="Enter Project Remarks" id='purchase-order' name='purchase-order'/>
                    </div>
