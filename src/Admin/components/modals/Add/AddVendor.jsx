    ...
    <div className={props.show}>
        <div className="xback-board txt-dark-bluex relative">
            ...
            <div className='modal-edit-head-v2 relative'>
                    ...
                    <h1 className=' p-2 pl-5 edit-modal-headr-x'>Add New Vendor</h1>
                </div>
                <form className="grid grid-cols-3 grid-row-7 gap-4 px-6 py-6">
                    <div className="col-span-3 text-left">
                        ...
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline " placeholder="Enter Vendor Name" id='vendor-name' name='vendor-name'/>
                    </div>
                    <div className="col-span-3 text-left">
                        <label className='text-blue-900' htmlFor="vendor-address">Address</label><br></br>
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline " placeholder="Enter Vendor's Address" id='vendor-address' name='vendor-address'/>
                    </div>
                    ...
                    <div className="col-span-3 md:col-span-1 text-left">
                        ...
                        <input type="text"className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="type" placeholder="Construction Materials" name='type'/>
                    </div>
