        ...
        <div className="xback-board">
            <div className="modal-inner">
                <div className='modal-edit-head-v2 relative'>
                    ...
                    <h1 className=' p-2 pl-5 edit-modal-headr-x'>Add New Meeting</h1>
                </div>
                <form className="grid grid-cols-4 xgrid-row-7 gap-4 px-10 py-6">
                        ...
                        <div className="col-span-4 text-left">
                            ...
                            <textarea type="text"className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="meeting-scope" placeholder="Enter Meeting Scope" name='meeting-scope' rows={3}></textarea>
                        </div>
