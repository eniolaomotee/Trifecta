    ...
    <div className={props.show}>
        <div className="xback-board txt-dark-bluex">
            ...
            <div className='modal-edit-head-v2 relative'>
                    ...
                    <h1 className=' p-2 pl-5 edit-modal-headr-x'>Add New Task</h1>
                </div>
                <form className="grid grid-cols-6 gap-4 px-10 py-6">
                    ...
                    <input type="submit" className="md:col-start-5 col-end-7 md:col-span-2 col-span-3 shadow appearance-none border rounded w-full py-2 px-3 text-white bg-blue-800 mt-2 focus:outline-none focus:shadow-outline" id='submit-button' value='Create Task'/>
                </form>
            </div>
        </div>
    </div>
