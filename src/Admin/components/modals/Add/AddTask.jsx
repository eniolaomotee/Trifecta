            ...
            <div className="modal-inner">
                ...
                <form className="grid grid-cols-6 gap-4">
                    ...
                    <div className="col-span-6 text-left">
                        ...
                        <input type="text" className="shadow appearance-none border rounded w-full py-2 px-3 bg-white mt-2 focus:outline-none focus:shadow-outline " placeholder="Enter Task Scope" id='scope' name='scope'/>
                    </div>
                    ...
                    <input type="submit" className="md:col-start-5 col-start-3 md:col-span-2 col-span-3 shadow appearance-none border rounded w-full py-2 px-3 text-white bg-blue-800 mt-2 focus:outline-none focus:shadow-outline" id='submit-button' value='Create Task'/>
                </form>
            </div>
        </div>
    </div>
