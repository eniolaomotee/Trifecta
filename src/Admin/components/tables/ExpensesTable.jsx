                            ...
                            <div className="shadow rounded-b-lg overflow-hidden xborder-b xborder-gray-200 xsm:rounded-lg">
                                <table className="min-w-full divide-y divide-gray-200 xtable-auto">
                                    ...
                                    <tbody className="bg-whitex divide-y divide-gray-200">
                                        {slice.map((e) => (
                                            <tr key={e.id}>
                                                <td className="px-6 py-4 whitespace-nowrap"><div>{e.expense_description}</div><div className='txt-greyed-out'>Project ID: {e.product_id}</div></td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm"><div>{e.authorized_by}</div></td>
