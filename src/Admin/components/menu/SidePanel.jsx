  ...
  <div className="fixed xcol-span-1 row-span-5 bg-whitex sidepanel z-10 shadow-lg xfixed">
    <div>
      ...
      <div className="text-left">
        ...
        <Link to="/dash_staff" className={active_selectr.staff}><StaffIcon classx='inline w-5 mr-3 stroke-current'/>Staff</Link>
        <Link to="/dash_vendors" className={active_selectr.vendors}><VendorsIcon classx='inline w-5 mr-3 stroke-current'/>Vendors</Link>
      ...
      <div className='mt-10 absolutebottom-3 '>
        <Link to="/settings" className={active_selectr.settings}><SettingsIcon classx='inline w-5 mr-3 stroke-current'/>Settings</Link>
        <Link to="/" className={active_selectr.logout}><LogOutIcon classx='inline w-5 mr-3 stroke-current'/>Log Out</Link>
    </div>
    </div>
  </div>
  );
