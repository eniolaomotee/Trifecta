...
export default function MiniSidePanel({active_selectr}) {
    
  return (
  <div className="fixed xcol-span-1 row-span-5 bg-white mini-sidepanel z-10 shadow-lg xfixed">
        ...
        <div className='xmt-8 absolute bottom-3 '>
          ...
          <Link to="/" className={active_selectr.settings}><LogOutIcon classx='inline w-5 mr-3 stroke-current'/></Link>
        </div>
  </div>
  );
}
