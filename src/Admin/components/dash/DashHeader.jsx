  ...
  return (
    <>
      ...
      <div className="headr bg-white flex pr-4">
          ...
          <div className=' text-blue-900 ml-auto mr-3 my-auto flex h-full align-middle py-4'>
            <span className='pr-10 relative top-1'><button onClick={handleShowMail}><EmailIcon classx='fill-current'/></button></span>
