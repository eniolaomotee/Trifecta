            ...
            <div className="bg-white rounded-lg p-8 w-4/5 mt-10 mx-auto">
                ...
                <form className="grid grid-cols-4 grid-row-7 gap-4">
                    ...
                    <div className="col-span-2 text-left">
                        ...
                        <input type="text"className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="cost-of-execution" type="text" placeholder="Enter Cost of Execution" name='cost-of-execution'/>
                    </div>
