...
export default function PendingBidsTr(props) {
    ...
    var naira_sign = '\u20a6';    
    var temp_table = [
        {namex: 'Bay City Expansion Project', client: 'Acme International', winning_company: 'fenovate nig ltd', statusx: 'approved', progress: '45%', amount: 34000, },
        {namex: 'Bay City Expansion Project', client: 'Acme International', winning_company: 'fenovate nig ltd', statusx: 'rejected', progress: '45%', amount: 34000, },
        {namex: 'Bay City Expansion Project', client: 'Acme International', winning_company: 'fenovate nig ltd', statusx: 'approved', progress: '45%', amount: 34000, },
        {namex: 'Bay City Expansion Project', client: 'Acme International', winning_company: 'fenovate nig ltd', statusx: 'pending', progress: '45%', amount: 34000, },
