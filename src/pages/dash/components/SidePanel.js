...
export var activex = "shadow-lg my-0 p-4 w-full text-blue-800 bg-colr block px-6";
export default function SidePanel({active_selectr}) {
  ...
  <div className="fixed xcol-span-1 row-span-5 bg-white sidepanel z-10 shadow-lg xfixed">
        ...
        <div className='mt-8'>
          ...
          <Link to="/" className={active_selectr.settings}><FontAwesomeIcon icon={['fas', 'sign-out-alt']} className='mr-3'/>Log Out</Link>
        </div>
  </div>
  );
}
