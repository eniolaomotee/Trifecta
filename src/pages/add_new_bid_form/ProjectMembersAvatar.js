            ...
            <div className="px-6 flex items-center flex-no-wrap">
               { av_images.map(avatar_image =>
                   ( <div className="w-12 h-12 bg-cover rounded-md -ml-2">
                        <img src={avatar_image} alt className="h-full w-full overflow-hidden object-cover rounded-full border-2 border-white xdark:border-gray-700 shadow" />
                    </div>)
                )}
                <div className="w-12 h-12 bg-cover rounded-md -ml-2 xsvg-container">
                    <img src={plus_image} alt className="h-full w-full overflow-hidden object-cover rounded-full border-2 border-white xdark:border-gray-700 shadow" />
