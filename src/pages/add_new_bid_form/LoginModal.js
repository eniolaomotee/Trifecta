       ...
       <div className="bg-white rounded-lg p-8 w-4/5 mt-10 mx-auto">
           ...
           <form className="grid grid-cols-4 grid-row-7 gap-4">
                <div className="col-span-2 text-left">
                    <label className='text-blue-900' for="project-title">Tender Title</label><br></br>
                ...
                <div className="col-span-2 text-left">
                    <label className='text-blue-900' for="client-name">Client</label>
                ...
                <div className="col-span-4 text-left">
                    <label className='text-blue-900' for="clent-name">Bidding Companies</label>
                ...
                <div className="md:col-span-2 col-span-4 text-left">
                    <label className='text-blue-900' for="winning-company">Winning Company</label><br></br>
                ...
                <div className="md:col-span-2 col-span-3 text-left">
                    <label className='text-blue-900' for="contract-sum">Contract Sum</label><br></br>
                ...
                <div className="md:col-span-1 col-span-4 text-left">
                    <label className='text-blue-900' for="reference-number">Reference Number</label><br></br>
                ...
                <div className="md:col-span-1 col-span-2 text-left">
                    <label className='text-blue-900' for="date-submitted">Date Submitted</label><br></br>
                ...
                <div className="md:col-span-1 col-span-2 text-left">
                    <label className='text-blue-900' for="bid-status">Bid Status</label><br></br>
                    <select  class="form-control shadow border rounded w-full py-2 px-3 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" name="" id="">
                ...
                {/* issue */}
                <div className="md:col-span-1 col-span-4 text-left">
                    <label className='text-blue-900' for="date-submitted">Project Team</label><br></br>
                ...
                <div className="md:col-span-2 col-span-4 row-span-5 text-left">
                    ...
                    <div className='grid grid-cols-4 gap-3'>
                        <div className="col-span-2 text-left">
                            <label className='text-blue-900' for="date-submitted">RFQ:</label><br></br>
                ...
                <div className="md:col-span-2 col-span-4 text-left">
                    <label className='text-blue-900' for="bid-scope">Scope</label><br></br>
