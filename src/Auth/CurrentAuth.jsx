...
export default function CurrentAuth() {
  ...
  if(currentAuthPage === 'SIGNUP'){return ( <SignUp/>)}
  else if(currentAuthPage === 'FORGOT_PASSWORD'){return (<ForgotPassword/>)}
  else if(currentAuthPage === 'RESET_CONFIRMATION'){return (<PasswordResetConfirmation/>)}
  else if(currentAuthPage === 'PASSWORD_RESET'){return (<ResetPassword/>)}
  else {return ( <LogIn/>)};
}