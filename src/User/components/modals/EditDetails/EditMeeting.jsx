            ...
            <div className="modal-inner-edit-x">
                ...
                <form className="grid grid-cols-6 gap-5 px-10 py-6">
                    <div className="col-span-6 text-left">
                        ...
                        <input type="text"className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="meeting-title" placeholder="Papaya Global check-in for the Project Onboarding Process" name='meeting-title'/>
                    </div>
                    <div className="col-span-6 text-left">
                        <label className='xtext-blue-900' htmlFor="meeting-scope">Meeting Scope</label>
                        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 xtext-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="meeting-scope" placeholder="Accumsan nisl, amet non in id justo ultricies pharetra. Nec velit ante praesent ullamcorper accumsan, scelerisque in semper sit. Vel neque duis at gravida diam. Tristique aliquet morbi massa morbi ac adipiscing. Nisi, cras in viverra sit blandit justo nunc, rhoncus ut. Est, consequat mauris fusce eleifend eget. Dui ut molestie nulla id blandit ac mi." name='meeting-scope'></textarea>
                    </div>
                    ...
                    <div className="col-span-6 text-left"> 
                        ...
                        <select className="shadow border rounded w-full py-2 px-3 text-blue-700 bg-gray-100 mt-2 focus:outline-none focus:shadow-outline" id="initiated-by" placeholder="James Brown" name='initiated-by'>
