...
export default function DashBids() {
    ...
    var  bids_temp = [
          ...
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/50/2022', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'approved', date_submitted: 'May 31, 2019'},
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/51/2022', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'rejected', date_submitted: 'May 31, 2019'},
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/52/2021', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'approved', date_submitted: 'May 31, 2019'},
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/53/2021', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'pending', date_submitted: 'May 31, 2019'},
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/54/2021', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'approved', date_submitted: 'May 31, 2019'},
          {name: 'Renovation and Construction works at GSSS Zadawa, Yobe State', TRF: 'TRF/NIG/55/2021', client: 'United Nations', winning_company: 'Acme Corporation', statusx: 'approved', date_submitted: 'May 31, 2019'}
        ]
  ...
  <div>
    ...
    <div className='dashboardx grid md:grid-cols-7 grid-cols-5'>
      ...
      <div className={`main-body col-span-7 row-span-5 bg-colr || xgrid xgrid-rows-10 xgap-2 ${showTile}`}>
        ...
        <div className="contentx">
          ...
          <div className="row-span-9 || grid grid-cols-3 grid-rows-3 gap-cus-1 gap-y-cus-1">
            {bids_temp.map(e=>{
              ...
              return(
                <div className=' bg-white rounded txt-darkblue2' key={e.TRF}>
                  <div className='p-3'>
      ...
      <BidDetails name={bids_temp[0].name} show={showDetails} handleShow={handleShowDetails}/>
